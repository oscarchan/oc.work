 ...
 * generated in the sandbox.liquibase.xml package. 
...
public class ObjectFactory {
    ...
    private final static QName _UpdateWhere_QNAME = new QName("http://www.liquibase.org/xml/ns/dbchangelog/1.9", "where");
    private final static QName _Comment_QNAME = new QName("http://www.liquibase.org/xml/ns/dbchangelog/1.9", "comment");
    private final static QName _LoadDataColumn_QNAME = new QName("http://www.liquibase.org/xml/ns/dbchangelog/1.9", "column");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sandbox.liquibase.xml
     * 
     */
    ...
    /**
     * Create an instance of {@link ModifyColumn }
     * 
     */
    public ModifyColumn createModifyColumn() {
    ...
    /**
     * Create an instance of {@link sandbox.liquibase.xml.Column }
     * 
     */
    public sandbox.liquibase.xml.Column createColumn() {
        return new sandbox.liquibase.xml.Column();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.liquibase.org/xml/ns/dbchangelog/1.9", name = "where", scope = Update.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.liquibase.org/xml/ns/dbchangelog/1.9", name = "comment")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.liquibase.org/xml/ns/dbchangelog/1.9", name = "column", scope = LoadData.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.liquibase.org/xml/ns/dbchangelog/1.9", name = "where", scope = Delete.class)
